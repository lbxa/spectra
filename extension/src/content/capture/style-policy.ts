...
export function shouldInlineStyleTag(tagName: string): boolean {
  return !INLINE_STYLE_TAG_BLOCKLIST.has(tagName.toLowerCase());
}

export function shouldKeepCssProperty(propertyName: string): boolean {
...
export function shouldDropStyleValue(propertyName: string, rawValue: string): boolean {
