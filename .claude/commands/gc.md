...
THEN commit with a clear and concise one-line commit message, using semantic commit notation with descriptor(scope): description with descriptor being chore|fix|feat|arch|etc.
